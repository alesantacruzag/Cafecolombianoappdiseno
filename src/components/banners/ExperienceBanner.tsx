...
function ButtonBase() {
  return (
    <div className="bg-[#f72585] content-stretch flex items-center justify-center overflow-clip px-[14px] py-[8px] relative rounded-[32px] shrink-0" data-name="_Button Base">
      <p className="font-poppins font-semibold leading-[20px] not-italic relative shrink-0 text-[14px] text-white">Conocer más</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[8px] items-end justify-center right-[20px] top-[calc(50%+3.5px)] w-[172px]">
...
export function ExperienceBanner() {
  return (
    <div className="backdrop-blur-[20.95px] bg-[#f5f5f5] overflow-clip relative rounded-[12px] w-full h-[180px]" data-name="Banner">
