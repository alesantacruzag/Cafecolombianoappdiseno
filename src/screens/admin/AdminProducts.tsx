...
export default function AdminProducts({ onNavigate }: AdminProductsProps) {
  const { products, addProduct, updateProduct, deleteProduct, experiences, addExperience, updateExperience, deleteExperience } = useApp();
        ...
        <div className="flex px-4">
          <button
            ...
            className={`flex-1 pb-4 font-['Poppins:SemiBold',sans-serif] text-[15px] transition-colors relative ${
              activeTab === 'products' ? 'text-[#f72585]' : 'text-[#717680]'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 pb-4 font-['Poppins:SemiBold',sans-serif] text-[15px] transition-colors relative ${
              activeTab === 'experiences' ? 'text-[#f72585]' : 'text-[#717680]'
            }`}
          >
            <div className="flex items-center justify-center gap-2">
              <Ticket size={18} />
