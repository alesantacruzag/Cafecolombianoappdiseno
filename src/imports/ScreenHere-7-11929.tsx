import svgPaths from "./svg-vqlqy4tk95";
  ...
  return (
    <div className="h-[28px] relative shrink-0 w-[101.657px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 101.657 28">
        <g id="Group 1">
          <path d={svgPaths.p28acbe80} fill="var(--fill-0, black)" id="Vector" />
          <path d={svgPaths.p33b39900} fill="var(--fill-0, black)" id="Vector_2" />
          <path d={svgPaths.pda2a100} fill="var(--fill-0, black)" id="Vector_3" />
          <path d={svgPaths.p2bfc6cc0} fill="var(--fill-0, black)" id="Vector_4" />
          <path d={svgPaths.p19ad800} fill="var(--fill-0, black)" id="Vector_5" />
          <path d={svgPaths.p3c9bb8b0} fill="var(--fill-0, black)" id="Vector_6" />
          <path d={svgPaths.p145fe300} fill="var(--fill-0, black)" id="Vector_7" />
          <path d={svgPaths.p66ad00} fill="var(--fill-0, black)" id="Vector_8" />
        </g>
      </svg>
    </div>
  );
...
function Header() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[64px] items-center justify-center relative shrink-0 w-[385px]" data-name="Header">
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center not-italic relative shrink-0">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[14px] relative shrink-0 text-[#535862] text-[10px]">Tangua · Nariño</p>
    </div>
  );
}
...
function Upload() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="upload-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="upload-01">
          <path d={svgPaths.p268f3d80} id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
        </g>
      </svg>
    </div>
  );
...
function Heart() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heart">
          <path clipRule="evenodd" d={svgPaths.p33969100} fillRule="evenodd" id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
        </g>
      </svg>
    </div>
  );
...
function Content() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Content">
      <p className="font-['Poppins:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#5e2fd3] text-[14px] text-center">250 gr</p>
    </div>
  );
}
...
function Tag() {
  return (
    <div className="bg-[#c4c4ff] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[32px] shrink-0" data-name="Tag">
      <Content />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#414651] text-[14px] text-ellipsis whitespace-nowrap">
        <p className="leading-[20px] overflow-hidden">Peso</p>
      </div>
      <Frame5 />
    </div>
  );
...
function Content4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Content">
      <p className="font-['Poppins:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#5e2fd3] text-[14px] text-center">Molido</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#414651] text-[14px] text-ellipsis whitespace-nowrap">
        <p className="leading-[20px] overflow-hidden">Molienda</p>
      </div>
      <Frame6 />
    </div>
  );
...
function BadgeBase() {
  return (
    <div className="bg-[#cee90d] content-stretch flex items-center justify-center px-[8px] py-[2px] relative rounded-[16px] shrink-0" data-name="_Badge base">
      <p className="font-['Poppins:Medium',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#5f6b05] text-[12px] text-center">15% dcto con Mastercard</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <p className="font-['Poppins:Regular',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#535862] text-[10px]">Miembro · Hace 3 años</p>
    </div>
  );
}
...
function ButtonBase1() {
  return (
    <div className="bg-white h-[44px] relative rounded-[32px] shrink-0" data-name="_Button Base">
      <div className="content-stretch flex h-full items-center justify-center overflow-clip px-[20px] py-[10px] relative rounded-[inherit]">
        <p className="font-['Poppins:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#535862] text-[14px]">Contactar</p>
      </div>
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <AvatarAndText />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[18px] min-w-full not-italic relative shrink-0 text-[#252b37] text-[12px] w-[min-content] whitespace-pre-wrap">
        <p className="mb-[12px]">Caficultor de tercera generación que cultiva su café en las montañas de Nariño, donde el clima y la altura crean perfiles de sabor únicos. Su proceso es artesanal y cuida cada etapa, desde la siembra hasta la cosecha manual.</p>
        <p>Su compromiso con la calidad, la sostenibilidad y el comercio justo se refleja en cada taza. Al elegir este café, apoyas a productores locales y disfrutas de un café con origen y carácter.</p>
      </div>
      <ButtonBase1 />
    </div>
  );
...
function X0023LayerX() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.23px]" data-name="__x0023_Layer_x0020_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 69.2304 18">
...
function Pay() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Pay">
      <Group />
...
function StarIcon() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Star icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_7_20444)" id="Star icon">
          <path d={svgPaths.p2f878000} fill="var(--fill-0, #F5F5F5)" id="Star background" />
          <g clipPath="url(#clip1_7_20444)" id="Star">
            <path d={svgPaths.p2f878000} fill="var(--fill-0, #FDB022)" id="Star_2" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_7_20444">
            <rect fill="white" height="20" width="20" />
          </clipPath>
          <clipPath id="clip1_7_20444">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
function StarIcon4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Star icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_7_17068)" id="Star icon">
          <path d={svgPaths.p2f878000} fill="var(--fill-0, #F5F5F5)" id="Star background" />
          <g clipPath="url(#clip1_7_17068)" id="Star">
            <path d={svgPaths.p2f878000} fill="var(--fill-0, #FDB022)" id="Star_2" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_7_17068">
            <rect fill="white" height="20" width="20" />
          </clipPath>
          <clipPath id="clip1_7_17068">
...
function StarIcon9() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Star icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_7_35655)" id="Star icon">
          <path d={svgPaths.p2f878000} fill="var(--fill-0, #F5F5F5)" id="Star background" />
          <g clipPath="url(#clip1_7_35655)" id="Star">
            <path d={svgPaths.p2f878000} fill="var(--fill-0, #FDB022)" id="Star_2" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_7_35655">
            <rect fill="white" height="20" width="20" />
          </clipPath>
          <clipPath id="clip1_7_35655">
...
function AttributionAndArrows() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Attribution and arrows">
      <Frame20 />
    </div>
  );
}
...
function QuoteAndAttribution() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[24px] relative rounded-[12px] shrink-0 w-[312px]" data-name="Quote and attribution">
      ...
      <div className="h-0 relative shrink-0 w-[36px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 1">
            <line id="Line 2" stroke="var(--stroke-0, #E9EAEB)" x2="36" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <p className="font-['Poppins:Regular',sans-serif] leading-[14px] min-w-full not-italic relative shrink-0 text-[#717680] text-[10px] w-[min-content] whitespace-pre-wrap">hace 2 semanas</p>
    </div>
  );
}
...
function AttributionAndArrows1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Attribution and arrows">
      <Frame24 />
    </div>
...
function QuoteAndAttribution1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] py-[24px] relative rounded-[12px] shrink-0 w-[312px]" data-name="Quote and attribution">
      <div aria-hidden="true" className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <AttributionAndArrows1 />
      <div className="h-0 relative shrink-0 w-[36px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 1">
            <line id="Line 2" stroke="var(--stroke-0, #E9EAEB)" x2="36" y1="0.5" y2="0.5" />
...
function SignUp() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Sign up">
      <div className="content-stretch flex flex-col gap-[32px] items-start pb-[39px] pt-[24px] px-[20px] relative w-full">
        <Frame19 />
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[385px]">
      <TabBar />
      <Bar />
    </div>
  );
...
function Mobile() {
  return (
    <div className="absolute bg-[#5e2fd3] content-stretch flex flex-col items-center justify-center left-[-1px] overflow-clip top-[-1px] w-[385px]" data-name="Mobile">
      <StatusBarIPhone />
      <Header />
      <SignUp />
      <Frame3 />
...
export default function ScreenHere() {
  return (
    <div className="border border-[#e9eaeb] border-solid overflow-clip relative rounded-[8px] size-full" data-name="screen-here">
      <div className="absolute bg-[#dae2d3] h-[805px] left-[-1px] rounded-[50px] top-[-1px] w-[370px]" data-name="screen" />
      <div className="absolute h-[819px] left-[-1px] top-[-1px] w-[385px]" data-name="Wallpaper (DELETE)">
